...
- Описание: Все сопрано и альты начинают движение в центральной области. Первые 3 секунды после старта движения все цели тянут к центру (нельзя уходить от центра). Далее у каждого мобильного регулярно обновляется цель (target) — по достижении цели или по таймауту. Механизмы избегания столкновений активны.
- Внутри этой стадии:
